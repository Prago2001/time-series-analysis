...
**Project Topic:** Foundational time-series models library (ARMA, GARCH, VAR)  **Group:** Time-Series Library Project  **Members:** Member 1, Member 2  
## Abstract
...
1. Load `testing/NIFTY_100_enriched.csv` into a Pandas DataFrame, parse dates, and select the `log_return` column.[cite:1]
